...
class CustomTextField extends StatefulWidget {
  ...
  const CustomTextField({Key? key, this.isPassword = false, required this.hint, required this.textController, required this.prefixIcon, this.isEnabled=true}) : super(key: key);

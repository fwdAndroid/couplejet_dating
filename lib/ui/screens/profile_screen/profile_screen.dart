          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                IconButton(
                  icon: Icon(Icons.tune_rounded,size: 24*widthScale,),
                  onPressed: (){
                    pushNewScreen(
                      context,
          ...
          Expanded(
            child: SingleChildScrollView(child:Column(
              children: [
                            ...
                            onTap: (){
                              ...
                              child: Container(
                                padding: EdgeInsets.all(6),
                                  ...
                                  child: Icon(Icons.edit_rounded,size: 24*widthScale,))
                          ),
                        ),
                      ],
                    ),
                ...
                Padding(
                  padding: EdgeInsets.only(left: 20*widthScale,right: 20*widthScale),
                  child: MainButton(
                ...
                CardContainer(
                  paddingHorizontal: 8,
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.only(left: 12 * widthScale, right: 12 * widthScale,bottom: 12*heightScale),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Row(
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [Text('Johanna, 22',style: GoogleFonts.outfit(fontSize: 15*widthScale,fontWeight: FontWeight.bold),)],
                                  ),
                                ],
                              ),
                              GestureDetector(
                        ...
                        Padding(
                          ...
                          child: Text('Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy'
                              ...
                              'Lorem ipsum dolor sit amet, consetetur sadipscing elit.',style: GoogleFonts.outfit(fontSize: 12*widthScale,),),
                        )
                      ],
                    )
                ),
